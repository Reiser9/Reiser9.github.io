		...
		<div class="container">
			<div class="main__inner">
						...
						<div class="card__info--inner">
							...
							<div class="card__info--adress--inner">
								...
								<div class="card__info--address--value">
									<span class="bold">Маршрут:</span> Волчанец
								</div>
							</div>
				...
				<div class="card__item--inner bb bt">
					<div class="card__info--inner full">
						<div class="card__info--title--inner">
							<div class="card__info--title--box">
						...
						<div class="card__text">
							Для того что бы узнать стоимость автотура нажмите  кнопку  снужным месяцем
						</div>

						<div class="card__month--buttons--inner">
							<button class="button month__button june">
								Июнь
							</button>

							<button class="button month__button jule">
								Июль
							</button>

							<button class="button month__button avgust">
								Август
							</button>

							<button class="button month__button september">
								Сентябрь
							</button>
						</div>

						<div class="month__scroll">
							<div class="card__month--table--inner">
								<div class="card__month--accardeon--inner">
									<button class="card__month--accardeon--button five">
										5 дней/4 ночи
									</button>

									<button class="card__month--accardeon--button six">
										6 дней/5 ночей
									</button>

									<button class="card__month--accardeon--button seven">
										7 дней/6 ночей
									</button>

									<button class="card__month--accardeon--button eight">
										8 дней/7 ночей
									</button>

									<button class="card__month--accardeon--button ten">
										10 дней/9 ночей
									</button>
								</div>

								<div class="card__month--table--cont">
									<div class="card__month--table--item">
										<div class="card__month--table--value bold">
											Даты заезда:
										</div>

										<div class="card__month--table--value">
											10.06– 15.06.2020
										</div>
									...
									<div class="card__month--table--item">
										...
										<div class="card__month--table--value card__day">
											5 дней/4 ночи
										</div>
